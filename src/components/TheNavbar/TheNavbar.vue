  ...
  <nav class="nav">
      <div class="nav__logo">
        ...
        <svg width="300" height="137" viewBox="0 0 300 137" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M206 132.238C234 142.751 262 134.341 290 121.724L296.5 118L303 112.5L300 0H-2.09808e-05C-22.1827 56.6857 -49.3869 105.157 38 98.5946C66 96.4919 94 79.6703 122 85.9784C150 92.2865 178 121.724 206 132.238Z" fill="white"/>
        </svg>
      </div>
