<template>
  <nav class="nav">
      ...
      <div class="nav__links-container">
          ...
          <div class="nav__links-link" :class="{ selected: this.$route.name == 'Library' }" id="Library" @click="changeView($event)">
          ...
          <div class="nav__links-link" :class="{ selected: this.$route.name == 'Settings' }" id="Settings" @click="changeView($event)">
