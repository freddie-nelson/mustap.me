  ...
  <nav class="nav">
      <div class="nav__logo">
        ...
        <svg width="300" height="137" viewBox="0 0 300 137" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M206 132.238C234 142.751 262 134.341 290 121.724L296.5 118L303 112.5L300 0H-2.09808e-05C-22.1827 56.6857 -49.3869 105.157 38 98.5946C66 96.4919 94 79.6703 122 85.9784C150 92.2865 178 121.724 206 132.238Z" />
        </svg>
      </div>
      ...
      <div class="nav__music-controller">
        <svg xmlns="http://www.w3.org/2000/svg" width="300" height="234" viewBox="0 0 300 234" fill="none">
          <path d="M0 234H300V90V36L288 39C275 42 250 48 225 47C200 45 175 36 150 27C125 18 100 9 75 5C50 0 25 0 13 0H0V90V234Z" fill="#242424"/>
        </svg>
...
export default {
    ...
    methods: {
      ...
      changeView(e) {
        ...
        this.$store.state.currentView = parent.id;
      }
    },
    mounted() {
