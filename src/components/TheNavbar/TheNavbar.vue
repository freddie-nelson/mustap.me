<template>
  <nav class="nav">
      ...
      <div class="nav__links-container">
          ...
          <div class="nav__links-link selected" id="Home" @click="changeView($event)">
          ...
          <div class="nav__links-link" id="Library" @click="changeView($event)">
          ...
          <div class="nav__links-link" id="Themes" @click="changeView($event)">
            <svg width="39" height="39" viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="nav__links-link" id="Profile" @click="changeView($event)">
            <svg width="39" height="39" viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="nav__links-link" id="Settings" @click="changeView($event)">
...
export default {
    ...
    methods: {
      ...
      changeView(e) {
        ...
        parent.parentNode.children.forEach(element => {
